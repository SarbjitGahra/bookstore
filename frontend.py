#backend sqlite db front end is tkinter lib
"""
A program that stores book informatio such as
Title, author, year, price

User can perform crud operations

User can perform these operations through
gui
...
def update_command():
    backend.update(selected_tuple[0],title_text.get(),
                   author_text.get(), year_text.get() ,price_text.get())
